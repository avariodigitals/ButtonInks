...
const subCategories = [
  { name: "Flyers & Leaflets", image: "https://placehold.co/283x287" },
  { name: "Brochures", image: "https://placehold.co/283x287" },
  { name: "Postcards", image: "https://placehold.co/283x287" },
  { name: "Posters", image: "https://placehold.co/283x287" },
  { name: "Business Cards", image: "https://placehold.co/283x287" },
];

const filterGroups = [
  {
    title: "Print Item",
    options: ["Flyers", "Brochures", "Postcards", "Posters", "Menus"]
  },
  {
    title: "Paper Quality",
    options: ["Standard", "Premium Gloss", "Matte", "Recycled"]
  },
  {
    title: "Size",
    options: ["A4", "A5", "DL", "Custom"]
  },
  {
    title: "Price Range",
      ...
      <section className="w-full p-6 bg-emerald-50 flex flex-col justify-start items-center gap-2.5">
        <div className="w-full max-w-[1280px] flex flex-col justify-center items-center gap-7 py-10">
          <nav className="px-3 py-2 rounded-md inline-flex justify-start items-center gap-1">
            ...
            <ChevronRight className="w-3.5 h-3.5 text-emerald-500" />
            <span className="text-center text-zinc-500 text-sm font-medium font-['Inter'] leading-5">Marketing Print</span>
          </nav>
          <h1 className="self-stretch text-center text-green-500 text-6xl font-bold font-['Outfit'] leading-tight md:leading-[65.66px]">Marketing Print</h1>
          <p className="w-full max-w-[480px] text-center text-zinc-500/90 text-base font-normal font-['Inter'] leading-6">High-quality printed materials to promote your business. From eye-catching brochures to professional flyers.</p>
        </div>
      </section>
