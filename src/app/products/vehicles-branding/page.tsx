...
const subCategories = [
  { name: "Full Wraps", image: "https://placehold.co/283x287" },
  { name: "Partial Wraps", image: "https://placehold.co/283x287" },
  { name: "Spot Graphics", image: "https://placehold.co/283x287" },
  { name: "Window Graphics", image: "https://placehold.co/283x287" },
  { name: "Magnetic Signs", image: "https://placehold.co/283x287" },
];

const filterGroups = [
  {
    title: "Vehicle Type",
    options: ["Car", "Van", "Truck", "Trailer", "Fleet"]
  },
  {
    title: "Branding Style",
    options: ["Full Wrap", "Partial", "Decals Only", "Lettering"]
  },
  {
    title: "Durability",
    options: ["Short-term (1-3 yrs)", "Long-term (5-7 yrs)", "Reflective"]
  },
  {
    title: "Price Range",
      ...
      <section className="w-full p-6 bg-emerald-50 flex flex-col justify-start items-center gap-2.5">
        <div className="w-full max-w-[1280px] flex flex-col justify-center items-center gap-7 py-10">
          <nav className="px-3 py-2 rounded-md inline-flex justify-start items-center gap-1">
            ...
            <ChevronRight className="w-3.5 h-3.5 text-emerald-500" />
            <span className="text-center text-zinc-500 text-sm font-medium font-['Inter'] leading-5">Vehicles Branding</span>
          </nav>
          <h1 className="self-stretch text-center text-green-500 text-6xl font-bold font-['Outfit'] leading-tight md:leading-[65.66px]">Vehicles Branding</h1>
          <p className="w-full max-w-[480px] text-center text-zinc-500/90 text-base font-normal font-['Inter'] leading-6">Turn your vehicle into a mobile billboard. Professional wraps and graphics for cars, vans, and fleets.</p>
        </div>
      </section>
...
export default VehiclesBrandingPage;
