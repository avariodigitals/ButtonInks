...
const subCategories = [
  { name: "Die-Cut Stickers", image: "https://placehold.co/283x287" },
  { name: "Kiss-Cut Stickers", image: "https://placehold.co/283x287" },
  { name: "Clear Stickers", image: "https://placehold.co/283x287" },
  { name: "Bumper Stickers", image: "https://placehold.co/283x287" },
  { name: "Wall Decals", image: "https://placehold.co/283x287" },
];

const filterGroups = [
  {
    title: "Sticker Type",
    options: ["Die-Cut", "Kiss-Cut", "Sheet", "Roll", "Holographic"]
  },
  {
    title: "Material",
    options: ["Vinyl", "Paper", "Clear", "Reflective"]
  },
  {
    title: "Lamination",
    options: ["Matte", "Glossy", "UV Resistant", "None"]
  },
  {
    title: "Price Range",
      ...
      <section className="w-full p-6 bg-emerald-50 flex flex-col justify-start items-center gap-2.5">
        <div className="w-full max-w-[1280px] flex flex-col justify-center items-center gap-7 py-10">
          <nav className="px-3 py-2 rounded-md inline-flex justify-start items-center gap-1">
            ...
            <ChevronRight className="w-3.5 h-3.5 text-emerald-500" />
            <span className="text-center text-zinc-500 text-sm font-medium font-['Inter'] leading-5">Stickers</span>
          </nav>
          <h1 className="self-stretch text-center text-green-500 text-6xl font-bold font-['Outfit'] leading-tight md:leading-[65.66px]">Custom Stickers</h1>
          <p className="w-full max-w-[480px] text-center text-zinc-500/90 text-base font-normal font-['Inter'] leading-6">High-quality custom stickers and decals for any use. Durable vinyl, vibrant colors, and custom shapes.</p>
        </div>
      </section>
