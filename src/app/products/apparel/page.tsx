...
const subCategories = [
  { name: "T-shirts", image: "https://placehold.co/283x287" },
  { name: "Hoodies", image: "https://placehold.co/283x287" },
  { name: "Polo Shirts", image: "https://placehold.co/283x287" },
  { name: "Outerwear", image: "https://placehold.co/283x287" },
  { name: "Hats & Caps", image: "https://placehold.co/283x287" },
];

const filterGroups = [
  {
    title: "Apparel Type",
    options: ["T-Shirts", "Hoodies", "Polo Shirts", "Jackets", "Activewear", "Headwear"]
  },
  {
    title: "Gender",
    options: ["Men", "Women", "Unisex", "Youth"]
  },
  {
    title: "Material",
    options: ["100% Cotton", "Polyester Blend", "Tri-Blend", "Fleece"]
  },
  {
    title: "Price Range",
      ...
      <section className="w-full p-6 bg-emerald-50 flex flex-col justify-start items-center gap-2.5">
        <div className="w-full max-w-[1280px] flex flex-col justify-center items-center gap-7 py-10">
          <nav className="px-3 py-2 rounded-md inline-flex justify-start items-center gap-1">
            ...
            <ChevronRight className="w-3.5 h-3.5 text-emerald-500" />
            <span className="text-center text-zinc-500 text-sm font-medium font-['Inter'] leading-5">Apparel</span>
          </nav>
          <h1 className="self-stretch text-center text-green-500 text-6xl font-bold font-['Outfit'] leading-tight md:leading-[65.66px]">Custom Apparel</h1>
          <p className="w-full max-w-[480px] text-center text-zinc-500/90 text-base font-normal font-['Inter'] leading-6">Premium quality custom t-shirts, hoodies, polos, and more. From high-quality embroidery to vibrant prints.</p>
        </div>
      </section>
