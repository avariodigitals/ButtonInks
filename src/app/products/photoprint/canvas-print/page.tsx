...
const canvasSizes = ["12x18", "18x24", "24x36", "Custom Size"];
...
const relatedProducts = [
  { name: "Custom Canvas Print", price: "from $39.99", minQty: "min 1", image: "https://placehold.co/310x220", badge: "Vibrant Colors", category: "Photoprints" },
  { name: "Framed Photo", price: "from $25.00", minQty: "min 1", image: "https://placehold.co/310x220", category: "Photoprints" },
  { name: "Acrylic Print", price: "from $55.00", minQty: "min 1", image: "https://placehold.co/310x220", category: "Photoprints" },
  { name: "Photo Book", price: "from $19.99", minQty: "min 1", image: "https://placehold.co/310x220", category: "Photoprints" },
];
      ...
      case "Description":
        return (
          <div className="flex flex-col gap-6 text-slate-600 text-xl font-normal font-['Inter'] leading-relaxed">
            <p>Gallery-wrapped canvas prints that turn your favorite photos into art. Printed with archival inks on premium textured canvas, stretched over solid wood frames. Ready to hang.</p>
            <ul className="list-disc list-inside flex flex-col gap-2">
              <li>Genuine artist-grade canvas</li>
              <li>1.5" deep solid wood stretcher bars</li>
      ...
      case "Ordering information":
        return (
          <div className="flex flex-col gap-4 text-slate-600 text-xl font-normal font-['Inter'] leading-8">
            <p>• Production time is 3-5 business days.</p>
            <p>• Carefully packaged in protective foam and sturdy boxes.</p>
            <p>• Satisfaction is guaranteed on color accuracy and build quality.</p>
          </div>
        );
      case "File Setup":
        return (
          <div className="flex flex-col gap-6 text-slate-600 text-xl font-['Inter'] leading-8">
            <h3 className="font-bold text-slate-900 mb-2">Resolution Requirements</h3>
            <p>For the best result, your image should be at least 150 DPI at the final print size. High-resolution JPEGs or TIFFs are recommended.</p>
          </div>
        );
      case "Template":
        return (
          <div className="flex flex-col gap-6">
            <h3 className="font-bold text-slate-900 mb-2">Download Layout Guides</h3>
            <div className="self-stretch px-4 py-4 rounded-[10px] border border-gray-300 flex justify-between items-center gap-4">
              <span className="text-slate-900 text-base font-bold font-['Inter']">Canvas Wrap Guide (18x24)</span>
          ...
          <div className="flex flex-col gap-10">
            <div className="flex flex-col md:flex-row gap-10 items-center md:items-start">
              <div className="w-64 p-6 bg-green-50 rounded-2xl flex flex-col items-center justify-center gap-2">
                ...
                <span className="text-zinc-500 text-sm font-normal font-['Inter']">Based on 840 reviews</span>
              </div>
            </div>
          </div>
        );
    ...
    <main className="w-full bg-white flex flex-col items-center">
      ...
      <section className="w-full px-4 md:px-20 py-4 border-b border-gray-200">
        <div className="max-w-[1280px] mx-auto flex items-center gap-2 text-sm">
          ...
          <Link href="/products/photoprint" className="text-emerald-500 hover:underline">Photoprints</Link>
          <ChevronRight className="w-4 h-4 text-gray-400" />
          <span className="text-gray-600">Custom Canvas Print</span>
        </div>
      </section>
      ...
      <section className="w-full max-w-[1280px] px-4 md:px-20 py-10 flex flex-col lg:flex-row gap-10">
        ...
        <div className="flex-1 flex flex-col gap-6">
          <div className="flex flex-col gap-3">
            <h1 className="text-slate-900 text-4xl font-semibold font-['Outfit'] leading-tight">Custom Canvas Print</h1>
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-500 text-xs font-normal font-['Inter']">(840 reviews)</span>
            </div>
            <p className="text-gray-600 text-sm font-normal font-['Inter'] leading-6">
              Turn your favorite photos into professional wall art. Gallery-wrapped and ready to hang.
            </p>
          </div>

          {/* Size Selection */}
          <div className="flex flex-col gap-3">
            <span className="text-slate-900 text-lg font-semibold font-['Inter']">Select Size (Inches)</span>
          ...
          <div className="flex flex-col gap-2">
            <div className="px-5 py-4 bg-green-50/50 rounded-xl flex items-center gap-4">
              <span className="text-green-700 text-3xl font-extrabold font-['Outfit']">$39.99</span>
              <div className="text-zinc-500 text-sm font-normal font-['Inter']">
                per print · Total: <span className="text-green-700 font-bold">${(39.99 * quantity).toFixed(2)}</span>
              </div>
            </div>
          </div>
          ...
          {relatedProducts.map((p, i) => (
            <div key={i} className="bg-white rounded-2xl shadow-sm border border-slate-900/5 flex flex-col overflow-hidden group hover:shadow-md transition-all">
              ...
              <div className="p-4 flex flex-col gap-3">
                ...
                <div className="flex items-center gap-1.5"><div className="flex gap-0.5">{[1,2,3,4,5].map(s => <Star key={s} className="w-3 h-3 text-orange-600 fill-orange-600" />)}</div><span className="text-slate-500 text-xs">4.9 (840)</span></div>
