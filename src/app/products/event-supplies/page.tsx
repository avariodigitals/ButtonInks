...
const subCategories = [
  { name: "Table Covers", image: "https://placehold.co/283x287" },
  { name: "Lanyards", image: "https://placehold.co/283x287" },
  { name: "Event Badges", image: "https://placehold.co/283x287" },
  { name: "Backdrops", image: "https://placehold.co/283x287" },
  { name: "Promotional Pens", image: "https://placehold.co/283x287" },
];

const filterGroups = [
  {
    title: "Event Type",
    options: ["Corporate", "Weddings", "Conferences", "Parties", "Trade Shows"]
  },
  {
    title: "Customization",
    options: ["Full Color Print", "One Color", "Engraved", "Embroidered"]
  },
  {
    title: "Price Range",
      ...
      <section className="w-full p-6 bg-emerald-50 flex flex-col justify-start items-center gap-2.5">
        <div className="w-full max-w-[1280px] flex flex-col justify-center items-center gap-7 py-10">
          <nav className="px-3 py-2 rounded-md inline-flex justify-start items-center gap-1">
            ...
            <ChevronRight className="w-3.5 h-3.5 text-emerald-500" />
            <span className="text-center text-zinc-500 text-sm font-medium font-['Inter'] leading-5">Event Supplies</span>
          </nav>
          <h1 className="self-stretch text-center text-green-500 text-6xl font-bold font-['Outfit'] leading-tight md:leading-[65.66px]">Event Supplies</h1>
          <p className="w-full max-w-[480px] text-center text-zinc-500/90 text-base font-normal font-['Inter'] leading-6">Make your next event unforgettable with custom supplies. From personalized badges to professional backdrops.</p>
        </div>
      </section>
...
export default EventSuppliesPage;
