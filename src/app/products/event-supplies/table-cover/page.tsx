...
const tableSizes = ["6ft Table", "8ft Table", "Custom Size"];
...
const relatedProducts = [
  { name: "Custom Table Cover", price: "from $89.99", minQty: "min 1", image: "https://placehold.co/310x220", badge: "Best Seller", category: "Event Supplies" },
  { name: "Event Badge", price: "from $1.50", minQty: "min 50", image: "https://placehold.co/310x220", category: "Event Supplies" },
  { name: "Lanyard", price: "from $0.99", minQty: "min 100", image: "https://placehold.co/310x220", category: "Event Supplies" },
  { name: "Roll-up Banner", price: "from $89.99", minQty: "min 1", image: "https://placehold.co/310x220", badge: "Popular", category: "SIGNAGE" },
];

export default function ProductDetailsPage() {
  const [mainImage, setMainImage] = useState(productImages[0]);
  const [selectedSize, setSelectedSize] = useState('6ft Table');
      ...
      case "Description":
        return (
          <div className="flex flex-col gap-6 text-slate-600 text-xl font-normal font-['Inter'] leading-relaxed">
            <p>Professional-grade polyester table covers with full-color dye-sublimation printing. Wrinkle-resistant and durable, perfect for trade shows, conferences, and events.</p>
            <ul className="list-disc list-inside flex flex-col gap-2">
              <li>Premium 300D Polyester</li>
              <li>Dye-sublimation printing for vibrant colors</li>
              <li>Wrinkle-resistant and machine washable</li>
              <li>Contoured or draped options available</li>
            </ul>
          </div>
        );
      case "Ordering information":
        return (
          <div className="flex flex-col gap-4 text-slate-600 text-xl font-normal font-['Inter'] leading-8">
            <p>• Lead time is 3-5 business days after artwork approval.</p>
            <p>• Ships nationwide. Local pickup available in Pearland, TX.</p>
      ...
      case "File Setup":
        return (
          <div className="flex flex-col gap-6 text-slate-600 text-xl font-['Inter'] leading-8">
            <h3 className="font-bold text-slate-900 mb-2">Artwork Specifications</h3>
            <p>150 DPI minimum. CMYK color mode. Keep important text 2" from the edges for bleed.</p>
          </div>
        );
      case "Template":
        return (
          <div className="flex flex-col gap-6">
            ...
            <div className="self-stretch px-4 py-4 rounded-[10px] border border-gray-300 flex justify-between items-center gap-4">
              <span className="text-slate-900 text-base font-bold font-['Inter']">6ft Table Cover Template</span>
          ...
          <div className="flex flex-col gap-10">
            <div className="flex flex-col md:flex-row gap-10 items-center md:items-start">
              <div className="w-64 p-6 bg-green-50 rounded-2xl flex flex-col items-center justify-center gap-2">
                ...
                <span className="text-zinc-500 text-sm font-normal font-['Inter']">Based on 120 reviews</span>
              </div>
            </div>
          </div>
        );
    ...
    <main className="w-full bg-white flex flex-col items-center">
      <section className="w-full px-4 md:px-20 py-4 border-b border-gray-200">
        <div className="max-w-[1280px] mx-auto flex items-center gap-2 text-sm">
          ...
          <Link href="/products/event-supplies" className="text-emerald-500 hover:underline">Event Supplies</Link>
          <ChevronRight className="w-4 h-4 text-gray-400" />
          <span className="text-gray-600">Custom Table Cover</span>
        </div>
      </section>
      ...
      <section className="w-full max-w-[1280px] px-4 md:px-20 py-10 flex flex-col lg:flex-row gap-10">
        ...
        <div className="flex-1 flex flex-col gap-6">
          <div className="flex flex-col gap-3">
            <h1 className="text-slate-900 text-4xl font-semibold font-['Outfit'] leading-tight">Custom Table Cover</h1>
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-500 text-xs font-normal font-['Inter']">(120 reviews)</span>
            </div>
            <p className="text-gray-600 text-sm font-normal font-['Inter'] leading-6">
              Professional-grade polyester table covers with full-color dye-sublimation printing.
            </p>
          </div>

          <div className="flex flex-col gap-3">
            <span className="text-slate-900 text-lg font-semibold font-['Inter']">Select Size</span>
          ...
          <div className="flex flex-col gap-2">
            <div className="px-5 py-4 bg-green-50/50 rounded-xl flex items-center gap-4">
              <span className="text-green-700 text-3xl font-extrabold font-['Outfit']">$89.99</span>
              <div className="text-zinc-500 text-sm font-normal font-['Inter']">
                per unit · Total: <span className="text-green-700 font-bold">${(89.99 * quantity).toFixed(2)}</span>
              </div>
            </div>
          </div>
          ...
          {relatedProducts.map((p, i) => (
            <div key={i} className="bg-white rounded-2xl shadow-sm border border-slate-900/5 flex flex-col overflow-hidden group hover:shadow-md transition-all">
              ...
              <div className="p-4 flex flex-col gap-3">
                ...
                <div className="flex items-center gap-1.5"><div className="flex gap-0.5">{[1,2,3,4,5].map(s => <Star key={s} className="w-3 h-3 text-orange-600 fill-orange-600" />)}</div><span className="text-slate-500 text-xs">4.8 (120)</span></div>
