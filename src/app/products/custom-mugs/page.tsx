...
const subCategories = [
  { name: "Ceramic Mugs", image: "https://placehold.co/283x287" },
  { name: "Travel Mugs", image: "https://placehold.co/283x287" },
  { name: "Enamel Mugs", image: "https://placehold.co/283x287" },
  { name: "Glass Mugs", image: "https://placehold.co/283x287" },
  { name: "Magic Mugs", image: "https://placehold.co/283x287" },
];

const filterGroups = [
  {
    title: "Mug Type",
    options: ["Ceramic", "Stainless Steel", "Glass", "Plastic"]
  },
  {
    title: "Capacity",
    options: ["11oz", "15oz", "20oz", "12oz Travel"]
  },
  {
    title: "Features",
    options: ["Microwave Safe", "Dishwasher Safe", "Hand-wash Only", "Insulated"]
  },
  {
    title: "Price Range",
      ...
      <section className="w-full p-6 bg-emerald-50 flex flex-col justify-start items-center gap-2.5">
        <div className="w-full max-w-[1280px] flex flex-col justify-center items-center gap-7 py-10">
          ...
          <nav className="px-3 py-2 rounded-md inline-flex justify-start items-center gap-1">
            ...
            <ChevronRight className="w-3.5 h-3.5 text-emerald-500" />
            <span className="text-center text-zinc-500 text-sm font-medium font-['Inter'] leading-5">Custom Mugs</span>
          </nav>

          {/* Title */}
          <h1 className="self-stretch text-center text-green-500 text-6xl font-bold font-['Outfit'] leading-tight md:leading-[65.66px]">Custom Mugs</h1>

          {/* Subtitle */}
          <p className="w-full max-w-[480px] text-center text-zinc-500/90 text-base font-normal font-['Inter'] leading-6">Personalized mugs for your morning coffee or corporate gifting. High-quality prints that last.</p>
        </div>
      </section>
