...
const bannerSizes = ["24\" x 80\"", "33\" x 80\"", "48\" x 80\""];
...
const relatedProducts = [
  { name: "Retractable Roll Banner", price: "from $89.99", minQty: "min 1", image: "https://placehold.co/310x220", badge: "Best Seller", category: "SIGNAGE" },
  { name: "Vinyl Banner", price: "from $25.00", minQty: "min 1", image: "https://placehold.co/310x220", category: "SIGNAGE" },
  { name: "X-Stand Banner", price: "from $45.00", minQty: "min 1", image: "https://placehold.co/310x220", category: "SIGNAGE" },
  { name: "Mesh Banner", price: "from $35.00", minQty: "min 1", image: "https://placehold.co/310x220", category: "SIGNAGE" },
];

export default function ProductDetailsPage() {
  const [mainImage, setMainImage] = useState(productImages[0]);
  const [selectedSize, setSelectedSize] = useState('33" x 80"');
      ...
      case "Description":
        return (
          <div className="flex flex-col gap-6 text-slate-600 text-xl font-normal font-['Inter'] leading-relaxed">
            <p>
              Our premium retractable banners are perfect for trade shows, retail displays, and events. Easy to set up and transport, featuring high-resolution graphics on curl-resistant vinyl.
            </p>
            <ul className="list-disc list-inside flex flex-col gap-2">
              <li>High-quality aluminum base</li>
              <li>Vibrant, full-color printing</li>
              <li>Curl-resistant 13oz vinyl material</li>
      ...
      case "File Setup":
        return (
          <div className="flex flex-col gap-6 text-slate-600 text-xl font-['Inter'] leading-8">
            ...
            <p>150 DPI minimum. CMYK color mode. Keep important text 1" from the edges.</p>
          </div>
        );
      case "Template":
        return (
          <div className="flex flex-col gap-6">
            ...
            <div className="self-stretch px-4 py-4 rounded-[10px] border border-gray-300 flex justify-between items-center gap-4">
              <span className="text-slate-900 text-base font-bold font-['Inter']">33" x 80" Banner Template</span>
    ...
    <main className="w-full bg-white flex flex-col items-center">
      ...
      <section className="w-full px-4 md:px-20 py-4 border-b border-gray-200">
        <div className="max-w-[1280px] mx-auto flex items-center gap-2 text-sm">
          ...
          <Link href="/products/banners" className="text-emerald-500 hover:underline">Banners</Link>
          <ChevronRight className="w-4 h-4 text-gray-400" />
          <span className="text-gray-600">Retractable Roll Banner</span>
        </div>
      </section>
      ...
      <section className="w-full max-w-[1280px] px-4 md:px-20 py-10 flex flex-col lg:flex-row gap-10">
        ...
        <div className="flex-1 flex flex-col gap-6">
          <div className="flex flex-col gap-3">
            <h1 className="text-slate-900 text-4xl font-semibold font-['Outfit'] leading-tight">Retractable Roll Banner</h1>
            ...
            <p className="text-gray-600 text-sm font-normal font-['Inter'] leading-6">
              Professional retractable banners for your next event or retail display. Easy setup, durable, and vibrant.
            </p>
          </div>

          {/* Size Selection */}
          <div className="flex flex-col gap-3">
            <span className="text-slate-900 text-lg font-semibold font-['Inter']">Banner Size</span>
