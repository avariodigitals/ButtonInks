...
const subCategories = [
  { name: "Vinyl Banners", image: "https://placehold.co/283x287" },
  { name: "Roll-up Banners", image: "https://placehold.co/283x287" },
  { name: "Mesh Banners", image: "https://placehold.co/283x287" },
  { name: "Fabric Banners", image: "https://placehold.co/283x287" },
  { name: "Flag Banners", image: "https://placehold.co/283x287" },
];

const filterGroups = [
  {
    title: "Banner Type",
    options: ["Vinyl", "Retractable", "X-Stand", "Mesh", "Fabric"]
  },
  {
    title: "Usage",
    options: ["Indoor", "Outdoor", "Tradeshow", "Storefront"]
  },
  {
    title: "Finishing",
    options: ["Grommets", "Hems", "Pole Pockets", "Reinforced Edges"]
  },
  {
    title: "Price Range",
      ...
      <section className="w-full p-6 bg-emerald-50 flex flex-col justify-start items-center gap-2.5">
        <div className="w-full max-w-[1280px] flex flex-col justify-center items-center gap-7 py-10">
          <nav className="px-3 py-2 rounded-md inline-flex justify-start items-center gap-1">
            ...
            <ChevronRight className="w-3.5 h-3.5 text-emerald-500" />
            <span className="text-center text-zinc-500 text-sm font-medium font-['Inter'] leading-5">Banners</span>
          </nav>
          <h1 className="self-stretch text-center text-green-500 text-6xl font-bold font-['Outfit'] leading-tight md:leading-[65.66px]">Custom Banners</h1>
          <p className="w-full max-w-[480px] text-center text-zinc-500/90 text-base font-normal font-['Inter'] leading-6">High-impact custom banners for business, events, and advertising. Premium vinyl, vibrant colors, fast shipping.</p>
        </div>
      </section>
