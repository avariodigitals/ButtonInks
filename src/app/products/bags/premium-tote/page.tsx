...
const colors = [
  { name: 'Natural', class: 'bg-[#F5F5DC] border-gray-300' },
...
const relatedProducts = [
  ...
  { name: "Drawstring Bag", price: "from $5.99", minQty: "min 50", image: "https://placehold.co/310x220", category: "Bags" },
  { name: "Backpack", price: "from $25.99", minQty: "min 10", image: "https://placehold.co/310x220", category: "Bags" },
];
      ...
      case "Description":
        return (
          <div className="flex flex-col gap-6 text-slate-600 text-xl font-normal font-['Inter'] leading-relaxed">
            <p>
              Eco-friendly, 100% cotton canvas tote bag. Reinforced handles and heavy-duty stitching for durability. Ideal for grocery shopping, events, or daily use.
            </p>
            <ul className="list-disc list-inside flex flex-col gap-2">
              <li>100% Cotton Canvas</li>
              <li>Reinforced stress points</li>
              <li>Durable and long-lasting</li>
              <li>Vibrant printing surface</li>
            </ul>
          </div>
        );
      case "Ordering information":
        return (
          <div className="flex flex-col gap-4 text-slate-600 text-xl font-normal font-['Inter'] leading-8">
            ...
            <p>• Sizing advice: Standard is 15" x 16", Large is 18" x 20".</p>
        ...
        return (
          <div className="flex flex-col gap-6">
            ...
            <div className="self-stretch px-4 py-4 rounded-[10px] border border-gray-300 flex justify-between items-center gap-4">
              <span className="text-slate-900 text-base font-bold font-['Inter']">Tote Print Template</span>
          ...
          <div className="flex flex-col gap-10">
            <div className="flex flex-col md:flex-row gap-10 items-center md:items-start">
              <div className="w-64 p-6 bg-green-50 rounded-2xl flex flex-col items-center justify-center gap-2">
                ...
                <span className="text-zinc-500 text-sm font-normal font-['Inter']">Based on 1,420 reviews</span>
              </div>
            </div>
          </div>
        );
    ...
    <main className="w-full bg-white flex flex-col items-center">
      <section className="w-full px-4 md:px-20 py-4 border-b border-gray-200">
        <div className="max-w-[1280px] mx-auto flex items-center gap-2 text-sm">
          ...
          <Link href="/products/bags" className="text-emerald-500 hover:underline">Bags</Link>
          <ChevronRight className="w-4 h-4 text-gray-400" />
          <span className="text-gray-600">Premium Canvas Tote</span>
        </div>
      </section>
      ...
      <section className="w-full max-w-[1280px] px-4 md:px-20 py-10 flex flex-col lg:flex-row gap-10">
        ...
        <div className="flex-1 flex flex-col gap-6">
          <div className="flex flex-col gap-3">
            <h1 className="text-slate-900 text-4xl font-semibold font-['Outfit'] leading-tight">Premium Canvas Tote</h1>
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-500 text-xs font-normal font-['Inter']">(1,420 reviews)</span>
            </div>
            <p className="text-gray-600 text-sm font-normal font-['Inter'] leading-6">
              Eco-friendly, 100% cotton canvas tote bag. Reinforced handles and heavy-duty stitching for durability.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-2.5">
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-500 text-xs font-normal font-['Inter']">Min. 25</span>
            </div>
            <div className="w-40 h-12 bg-white rounded-lg border border-green-900/10 flex items-center overflow-hidden">
              <button onClick={() => setQuantity(Math.max(25, quantity - 1))} className="w-10 h-full flex items-center justify-center hover:bg-gray-50 transition-colors"><Minus className="w-4 h-4 text-neutral-700" /></button>
          ...
          <div className="flex flex-col gap-2">
            <div className="px-5 py-4 bg-green-50/50 rounded-xl flex items-center gap-4">
              <span className="text-green-700 text-3xl font-extrabold font-['Outfit']">$12.99</span>
              <div className="text-zinc-500 text-sm font-normal font-['Inter']">
                per unit · Total: <span className="text-green-700 font-bold">${(12.99 * quantity).toFixed(2)}</span>
              </div>
            </div>
          </div>
          ...
          {relatedProducts.map((p, i) => (
            <div key={i} className="bg-white rounded-2xl shadow-sm border border-slate-900/5 flex flex-col overflow-hidden group hover:shadow-md transition-all">
              ...
              <div className="p-4 flex flex-col gap-3">
                ...
                <div className="flex items-center gap-1.5"><div className="flex gap-0.5">{[1,2,3,4,5].map(s => <Star key={s} className="w-3 h-3 text-orange-600 fill-orange-600" />)}</div><span className="text-slate-500 text-xs">4.8 (1,420)</span></div>
