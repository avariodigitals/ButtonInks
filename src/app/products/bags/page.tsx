...
const subCategories = [
  { name: "Tote Bags", image: "https://placehold.co/283x287" },
  { name: "Backpacks", image: "https://placehold.co/283x287" },
  { name: "Drawstring Bags", image: "https://placehold.co/283x287" },
  { name: "Duffel Bags", image: "https://placehold.co/283x287" },
  { name: "Laptop Sleeves", image: "https://placehold.co/283x287" },
];

const filterGroups = [
  {
    title: "Bag Type",
    options: ["Tote", "Backpack", "Drawstring", "Duffel", "Messenger"]
  },
  {
    title: "Material",
    options: ["Canvas", "Polyester", "Nylon", "Eco-friendly Cotton"]
  },
  {
    title: "Features",
    options: ["Zippered", "Padded", "Water-resistant", "Adjustable Straps"]
  },
  {
    title: "Price Range",
      ...
      <section className="w-full p-6 bg-emerald-50 flex flex-col justify-start items-center gap-2.5">
        <div className="w-full max-w-[1280px] flex flex-col justify-center items-center gap-7 py-10">
          ...
          <nav className="px-3 py-2 rounded-md inline-flex justify-start items-center gap-1">
            ...
            <ChevronRight className="w-3.5 h-3.5 text-emerald-500" />
            <span className="text-center text-zinc-500 text-sm font-medium font-['Inter'] leading-5">Bags</span>
          </nav>

          {/* Title */}
          <h1 className="self-stretch text-center text-green-500 text-6xl font-bold font-['Outfit'] leading-tight md:leading-[65.66px]">Custom Bags</h1>

          {/* Subtitle */}
          <p className="w-full max-w-[480px] text-center text-zinc-500/90 text-base font-normal font-['Inter'] leading-6">Durable and stylish custom bags for every occasion. From eco-friendly totes to professional backpacks.</p>
        </div>
      </section>
