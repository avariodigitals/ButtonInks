...
const subCategories = [
  { name: "Executive Pens", image: "https://placehold.co/283x287" },
  { name: "Notebooks", image: "https://placehold.co/283x287" },
  { name: "Gift Sets", image: "https://placehold.co/283x287" },
  { name: "Tech Gadgets", image: "https://placehold.co/283x287" },
  { name: "Awards & Plaques", image: "https://placehold.co/283x287" },
];

const filterGroups = [
  {
    title: "Gift Category",
    options: ["Office Essentials", "Tech & Gadgets", "Wellness & Lifestyle", "Drinkware", "Leather Goods"]
  },
  {
    title: "Recipient",
    options: ["Executive", "Employee", "Client", "New Hire"]
  },
  {
    title: "Material",
    options: ["Leather", "Metal", "Bamboo/Wood", "Recycled Plastic"]
  },
  {
    title: "Price Range",
      ...
      <section className="w-full p-6 bg-emerald-50 flex flex-col justify-start items-center gap-2.5">
        <div className="w-full max-w-[1280px] flex flex-col justify-center items-center gap-7 py-10">
          <nav className="px-3 py-2 rounded-md inline-flex justify-start items-center gap-1">
            ...
            <ChevronRight className="w-3.5 h-3.5 text-emerald-500" />
            <span className="text-center text-zinc-500 text-sm font-medium font-['Inter'] leading-5">Corporate Gifts</span>
          </nav>
          <h1 className="self-stretch text-center text-green-500 text-6xl font-bold font-['Outfit'] leading-tight md:leading-[65.66px]">Corporate Gifts</h1>
          <p className="w-full max-w-[480px] text-center text-zinc-500/90 text-base font-normal font-['Inter'] leading-6">Elevate your brand with premium personalized gifts. Perfect for clients, employees, and special events.</p>
        </div>
      </section>
