 ...
 *
 * Returns curated print-ready design templates as JSON.
 * Templates are categorised by use-case so the editor can filter them.
 *
 * Each template contains an array of DesignElement-compatible objects
 * that can be dropped straight into the canvas.
 */
...
export interface DesignTemplate {
  ...
  name:        string;
  category:    string;
  thumbnail:   string;   // emoji used as visual preview
