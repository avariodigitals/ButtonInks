...
export const BRAND_COLOR_OVERRIDES: Record<string, string | [string, string]> = {
  ...
  'royal/white':              ['#1F4FA0', '#FFFFFF'],
  'red/white':                ['#CC1F1F', '#FFFFFF'],
  'black/gold':               ['#1C1C1C', '#C8901A'],
  'forest green/white':       ['#2D6A35', '#F5F5F5'],
  'kelly green/white':        ['#2FAD4A', '#F5F5F5'],
  'maroon/white':             ['#6B0F1A', '#F5F5F5'],
  'cardinal/white':           ['#8C1A2E', '#F5F5F5'],
  'purple/white':             ['#7C3AED', '#F5F5F5'],
  'orange/white':             ['#E85D0A', '#F5F5F5'],
  'gold/white':               ['#C8901A', '#F5F5F5'],
